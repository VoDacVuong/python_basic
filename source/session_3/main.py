...
#Convert to pdf
import pdfkit
# message = "Đây là thông điệp từ func convert pdf"
file_html = 'C:\\Users\\ADMIN\Desktop\\TPS_soft\\IUH.html'
url_html = 'https://google.com/'

example.html2pdf(html_file_name_or_url_html=url_html, pdf_file_name = 'output.pdf')
example.html2pdf(html_file_name_or_url_html=file_html, pdf_file_name = 'output.pdf')
